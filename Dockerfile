...
#   - https://hub.docker.com/_/debian/tags?name=bookworm-20241223-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: docker.io/hexpm/elixir:1.18.0-erlang-27.1.3-debian-bookworm-20241223-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/footy_live ./
