defmodule FootyLiveWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: FootyLiveWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FootyLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FootyLiveWeb.Gettext, "errors", msg, opts)
    end
  end
